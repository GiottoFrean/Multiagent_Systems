...
<p align="center">
  <img src="../images/8 Communication/A - Doing by talking I (cheap talk)_cell3_img1.svg" alt="Cheap talk game" width="500"/>
</p>
...
**Signalling games** involve private information and costly signals. Education signals ability, warranties signal quality, peacock tails signal fitness. Unlike cheap talk, signals are credible because they're costly. **Separating vs pooling equilibria** determine whether information is revealed.

---

## C - Doing by Talking II (Speech-Act Theory)

**Speech-act theory** studies how utterances perform actions. Some communication is **self-committing** (creates obligations) or **self-revealing** (credibly reveals information). Examples: burning bridges, public announcements, contracts. Connection to mechanism design.